...
const ParallaxBackgroundImages: FunctionComponent<{ scrollContainerId: string }> = ({scrollContainerId}) => {
    const pos = useScrollPosition(scrollContainerId, 0.5).position;
    ...
    return (
        <div className="background-image-container"
             style={{"willChange": "transform", "transform": `translateY(${pos}px)`}}>
...
export {ParallaxBackgroundImages};